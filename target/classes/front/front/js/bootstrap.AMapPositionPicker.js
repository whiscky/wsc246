...
// BootstrapAMapPositionPicker 是一个基于 Bootstrap 和高德地图（AMap）的位置选择器插件。
// 它允许用户在一个简洁、易用的界面中通过地图选择地理位置，并获取该位置的详细信息（如经纬度、地址等）。
// 该插件非常适合需要在网页中集成地图选址功能的项目，如在线预订系统、物流管理系统等。
(function (factory) {
    'use strict';
